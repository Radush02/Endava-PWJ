...
class AuthenticationServiceImplTest {
    ...
    void registerUser_whenUsernameOrEmailExists_throwsAlreadyExistsException() {
        when(userRepository.existsByUsernameOrEmailIgnoreCase("radush", "radush@radush.ro")).thenReturn(true);
    ...
    void registerUser_whenValid_savesUser_createsToken_andReturnsMessageAndToken() {
        when(userRepository.existsByUsernameOrEmailIgnoreCase("radush", "radush@radush.ro")).thenReturn(false);
    ...
    void validateEmail_whenValid_deletesEmailToken_andReturnsMessage() {
        ...
        when(emailValidationRepository.findByValidationHash(hash))
...
@Test
    ...
    void login_whenAccountLocked_throwsAccountLockedException() {
        ...
        AccountLockedException ex = assertThrows(AccountLockedException.class, () -> service.login(dto).join());
