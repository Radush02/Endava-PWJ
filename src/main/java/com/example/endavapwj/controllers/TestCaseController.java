...
public class TestCaseController {
    ...
    @PostMapping("/create")
    public CompletableFuture<ResponseEntity<Map<String,String>>> createTestCase(@RequestBody CreateTestCaseDTO createTestCaseDTO) {
        return testCaseService.addTestCase(createTestCaseDTO).thenApply(body -> ResponseEntity.status(HttpStatus.CREATED).body(body));
    }
}
