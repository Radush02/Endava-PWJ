...
public class ProblemController {
    ...
    @PostMapping("/create")
    public CompletableFuture<ResponseEntity<Map<String, String>>> create(@RequestBody CreateProblemDTO createProblemDTO) {
        return problemService.create(createProblemDTO)
